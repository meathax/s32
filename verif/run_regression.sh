...
echo "[36b] SegaSonic level-order protection device"
iverilog -g2012 -s tb_s32_prot_sonic -o /tmp/s32_prot_sonic \
  rtl/s32_pkg.sv rtl/prot/s32_prot.sv verif/tb_s32_prot_sonic.sv
vvp /tmp/s32_prot_sonic | grep -q "PASS tb_s32_prot_sonic" && \
  echo "SEGASONIC LEVEL ORDER: PASS" || { echo "SEGASONIC LEVEL ORDER: FAIL"; exit 1; }
iverilog -g2012 -DSIMULATION -DS32_SYSTEM32_ONLY -DS32_PROFILE_STANDARD -DS32_PCB_TIMING \
  -s tb_sonic_prot_integ -o /tmp/s32_sonic_prot_integ \
  rtl/s32_pkg.sv rtl/cpu/v60/s32_v60.sv rtl/cpu/v60/s32_v60_bus.sv \
  rtl/video/*.sv rtl/crt_adjust.sv rtl/audio/s32_rf5c68.sv rtl/audio/s32_multipcm.sv \
  rtl/audio/s32_audio_mix.sv rtl/audio/s32_soundsys.sv rtl/io/s32_io.sv rtl/prot/s32_prot.sv \
  verif/common/jt12_stub.v rtl/s32_core.sv verif/common/tb_sonic_prot_integ.sv
vvp /tmp/s32_sonic_prot_integ | grep -q "SEGASONIC PROT INTEG PASS" && \
  echo "SEGASONIC PROT INTEGRATION: PASS" || { echo "SEGASONIC PROT INTEGRATION: FAIL"; exit 1; }
