...
# B0 board bits: bit1=has_v25 bit2=v25_table(1=arabfgt) bit3=has_adc
#                bit4=has_track bit5=has_ppi
# B1 board bits: bit0=dual_pcb bit1=flip_y bit2=gun_aim bit3=coin_swap
...
case "$GAME" in
  ...
  alien3)  B0=8; B1=c ;; # has_adc + positional-gun invert + coin swap
