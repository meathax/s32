...
try {
    ...
    Write-Tier 36 "SegaSonic level-order protection contract"
    Run-HdlTest "t36_prot_sonic" "tb_s32_prot_sonic" @(
        "rtl/s32_pkg.sv", "rtl/prot/s32_prot.sv", "verif/tb_s32_prot_sonic.sv"
    ) "PASS tb_s32_prot_sonic"

    Write-Tier 36 "SegaSonic protection against the real ROM cache and work-RAM ports"
    Run-HdlTest "t36_prot_sonic_integ" "tb_sonic_prot_integ" @(
        "rtl/s32_pkg.sv", "rtl/s32_core.sv", "rtl/prot/s32_prot.sv",
        "rtl/video/s32_big_dpram.sv", "verif/common/tb_sonic_prot_integ.sv"
    ) "SEGASONIC PROT INTEG PASS" @(
        "SIMULATION", "S32_SYSTEM32_ONLY", "S32_PROFILE_STANDARD", "S32_PCB_TIMING"
    )
