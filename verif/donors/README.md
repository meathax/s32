...
| D006 | [meathax/s32multi](https://github.com/meathax/s32multi/tree/1e89f67005ae0eb11ae0622cb52e8214c78ed76e), `1e89f67005ae0eb11ae0622cb52e8214c78ed76e` | GPL-3.0 | Paddle, spinner-toggle, and mouse-relative event handling adapted into `rtl/io/s32_driving_controls.sv`; the target keeps an isolated project-owned wrapper | Adapted and regression-tested; donor `LICENSE` retained in the source project |
