...
// Count rendering rising edges and disp_buf changes globally.
...
always @(posedge clk) begin
    ...
    disp_buf_d  <= disp_buf;
    if (rendering && !rendering_d) render_edges = render_edges + 1;
    if (disp_buf !== disp_buf_d)   swap_edges   = swap_edges + 1;
end
