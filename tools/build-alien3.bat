...
:build_lock_acquired
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0sync-alien3-qsf.ps1"
set "SYNC_RESULT=%ERRORLEVEL%"
if not "%SYNC_RESULT%"=="0" goto :sync_failed

set "S32_PROJECT=s32Alien3"
set "S32_REVISION=s32Alien3"
set "S32_RELEASE_NAME=s32Alien3"
