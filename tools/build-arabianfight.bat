...
:build_lock_acquired
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0sync-arabianfight-qsf.ps1"
set "SYNC_RESULT=%ERRORLEVEL%"
if not "%SYNC_RESULT%"=="0" goto :sync_failed

set "S32_PROJECT=s32ArabianFight"
set "S32_REVISION=s32ArabianFight"
set "S32_RELEASE_NAME=s32ArabianFight"
set "S32_FIT_SEED=1"
