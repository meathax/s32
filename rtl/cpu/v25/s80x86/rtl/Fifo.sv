...
`ifdef S32_V25_MLAB_FIFO
// The two V25 prefetch/decode FIFOs are only 48 and roughly 300 bits. Quartus
// otherwise spends three M10Ks on them; the archived memory report confirms
// both shapes fit MLAB. Keep this release-only so generic s80x86 is unchanged.
